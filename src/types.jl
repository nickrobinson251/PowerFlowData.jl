...
"""
abstract type SwitchedShunts <: Records end

for v in (30, 33)
    T = Symbol(:SwitchedShunts, v)
    adjm_doc, adjm_col = if v == 33
        :("""
        Adjustment method:
...
for R in (
    ...
    :VSCDCLines,
    :SwitchedShunts30, :SwitchedShunts33,
...
_summary(::Type{<:SwitchedShunts}) = "SwitchedShunts"
